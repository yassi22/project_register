...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="aanpas-pagina.php" class="btn btn-lg d-flex justify-content-end d-none d-md-block knop-aanpassen" role="button">Project
          aanpassen</a>
        <a href="overzicht-pagina.php" class="btn btn-lg d-flex justify-content-end d-none d-md-block knop-verwijder"
  ...
  <div class="d-flex flex-column">
        ...
        <a href="aanpas-pagina.php" class="btn btn-lg d-flex justify-content-center knop-aanpassen" role="button">Project
          aanpassen</a>
        <a href="overzicht-pagina.php" class="btn btn-lg d-flex justify-content-center knop-verwijder"
          role="button">Project verwijderen</a>
      </div>
